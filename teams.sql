...
CREATE USER 'nfl'@'localhost' IDENTIFIED WITH mysql_native_password BY 'nFLt3Am5';

GRANT ALL ON nfl.* TO 'nfl'@'localhost';
...
INSERT INTO TEAMS (location, mascot, abbreviation, conference, division) VALUES ('Detroit', 'Lions', 'DET', 'NFC', 'North');
